...
Critical formatting rule: "text" must be plain prose only. Never include
citation markup, footnotes, source tags, bracketed numbers, or anything
like ... or [1] — just write the sentences naturally, as Gary
would say them out loud, with no visible trace of research formatting.
`;
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Safety net: strip any citation markup that slipped through, keeping
    // the inner text so sentences still read naturally.
